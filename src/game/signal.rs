...
pub fn generate_signal_map(rect: rogue_algebra::Rect, seed: u32) -> SignalMap {
    ...
    for x in rect.x1..=rect.x2 {
        for y in rect.y1..=rect.y2 {
            let n = simplex_noise_2d_seeded(Vec2::new(x as f32 * 0.1, y as f32 * 0.1), seed as f32);
            ...
            let s = (base + n * 0.5).clamp(0.0, 1.0);
...
mod tests {
    ...
    fn test_signal_map_variation() {
        ...
        let seed = 12345;
        let signal_map = generate_signal_map(rect, seed);
